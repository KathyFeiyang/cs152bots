# confusion matrix for gpt classifier

import csv
from gpt4_classifier import GPT4MisinformationClassifier
...
def main():
    classifier = GPT4MisinformationClassifier("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")
